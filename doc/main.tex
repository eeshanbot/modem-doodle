\title[JASA/Sample JASA Article]{In situ estimation of sound speed profiles and horizontal group velocities for range estimation between under ice acoustic modems}%{Considering vertical sound speed uncertainty in the Beaufort Lens for more realistic range estimation between acoustic modems}
