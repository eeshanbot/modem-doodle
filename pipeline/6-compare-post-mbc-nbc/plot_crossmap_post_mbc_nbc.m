...
%% isovelocity
iso.xVal = iso.avg .* DATA.owtt(INDEX.valid) - DATA.recRange(INDEX.valid);
iso.yVal = iso.xVal;
iso.F = h_cross_plot_stat(iso.xVal,iso.yVal);
...
baseval.F = h_cross_plot_stat(baseval.xVal,baseval.yVal);
...
eeof.F = h_cross_plot_stat(eeof.xVal,eeof.yVal);
...
hycom.F = h_cross_plot_stat(hycom.xVal,hycom.yVal);
...
function [F] = h_cross_plot_stat(xVal,yVal)
