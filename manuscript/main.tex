...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\reprintcolumnwidth]{figs/ssp-gvel-large.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=\textwidth]{figs/trilateration-3-ways.pdf}
\caption{WRITE THIS. Needs font change, legend change, x-axis change, new color palette.}
\label{fig:trilat}
\end{figure}
