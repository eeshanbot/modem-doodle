...
Then a single value is selected that best matches the recorded travel time, as the detected arrival is not always the first arrival or the direct path and could even be masked by noise or blocked temporarily \citep{deffenbaugh1996acoustic}.
...
\llabel{1.20} A fast tomographic estimate \citep{Deffenbaugh1997,Elisseeff2002}, along with its uncertainty, can be continuously communicated to assets underway to maintain contact or enable adaptive sampling.
...
The methods presented in this paper, including the software projects \citep{benjamin2010nested,schneider2010unified,schneider2015dynamic}, are open source and platform agnostic.
